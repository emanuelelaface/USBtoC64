/*
CUSTOMIZATION FOR Generic USB Joystick, USB 121:6	
...
void c64_joystick_m(const uint8_t *const data, const int length) {
  ...
  if ((data[0] < 64) | (data[0] > 190)){
    delayOnX += (data[0]-127)/3;
  }
