/*
CUSTOMIZATION FOR Retrolink Saturn Classic, USB 121:17
...
void c64_joystick_j(const uint8_t *const data, const int length) {
  ...
  if ((data[6] == 31) | (data[6] == 47) | (data[6] == 79)) {
      isfire = true;
  }
  if (isup) {
    pinMode(C64_UP, OUTPUT);
