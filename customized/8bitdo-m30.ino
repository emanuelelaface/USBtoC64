/*
CUSTOMIZATION FOR 8Bitdo M30, USB 11720:20486
...
void c64_joystick_j(const uint8_t *const data, const int length) {
  ...
  if ((data[1] == 1) | (data[1] == 2) | (data[1] == 128)) {
      isfire = true;
  }
  if (isup) {
    pinMode(C64_UP, OUTPUT);
